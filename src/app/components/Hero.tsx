  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-12 right-20 h-72 w-72 rounded-full bg-blue-500/10 blur-3xl"></div>
      </div> 
      ...
      <div className=" max-w-3xl mx-auto text-center">
        <div className="flex flex-col items-center mb-4">
          <motion.div {...scaleIn} transition={{delay:0.2}}>
            ...
            width={500}
            height={500}
            className="rounded-full mb-4 w-45 h-45 object-cover ring-4 ring-primary/60 shadow-2xl shadow-primary/25"
          />
          </motion.div>
